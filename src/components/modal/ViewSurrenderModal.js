    ...
    <div
      ...
      <div
        ...
        <div
          ...
          <label style={{ fontSize: 10, color: 'red', fontStyle: 'italic' }}>
      ...
      <div
        ...
        <div
          ...
          <label style={{ fontWeight: 'bold' }}>DAMILAG BARANGAY COUNCIL</label>
          ...
          <label style={{ fontWeight: 'bold' }}>EDUARDO RALPH S. BAGAYAS</label>
          ...
          <label style={{ fontWeight: 'bold' }}>JHON GABRIEL D. GAMIL</label>
        ...
        <div
          ...
          <div
            ...
            <label style={{ textAlign: 'justify', lineHeight: 2 }}>
              That I the owner, waive all my rights and ownership of the said
              animal and that the Barangay, The Manolo Fortich, DA has no
              responsibility or liability or whatsoever for the act of putting
              the animal to sleep, this {moment(new Date()).format('MMMM')} day
              of {moment(new Date()).format('DD')}{' '}
...
ViewSurrenderModal.defaultProps = {
  isOpen: false
}

ViewSurrenderModal.propTypes = {
  isOpen: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired
}

export default ViewSurrenderModal

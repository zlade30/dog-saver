            ...
            <div
              ...
              <div
                ...
                <label style={{ textAlign: 'justify', lineHeight: 3 }}>
                  AKO/KAMI SI {renderField()} NGA LUMULUPYO SA PUROK-
                  {renderField()} DAMILAG, MANOLO FORTICH, BUKIDNON. NGA KAMI
                  NANAG-IYA SA IRO/IRING NGA (KASARIAN) {renderField()} (COLOR)
                  {` ${renderField()}`} NGA NADAKPAN SA ATONG BARANGAY DOG
                  IMPOUNDING PERSONNEL DIDTO SA {renderField()} NIADTONG
                  {renderField()} KAMI NASAYOD NGA ADUNA KAMI TULUBAGON
                  PINANSYAL NGA NAGKATIDAD (P10.00/DAY DOG FOOD) {renderField()}
                  , (P100.00 AGREEMENT FEE). {renderField()}, UG MULTA (P500 -
                  FIRST OFFENSE, P1,500 - SECOND OFFENSE AS PER MUN. ORD. NO.
                  2019-1255) {renderField()} 1st/2nd OFFENSE.
                </label>
              </div>
              <div
                style={{
